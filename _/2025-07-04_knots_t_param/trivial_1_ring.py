...
PR = PolynomialRing(QQ, 'z_7,z_6,z_5,z_4,z_3,z_2,z_1,q')
PR.inject_variables()
...
t, matrix_min_5 = knotting_min(t, z_5, F=F, param=q)
t, matrix_min_6 = knotting_min(t, z_6, F=F, param=q)
t, matrix_min_7 = knotting_min(t, z_7, F=F, param=q)
t, matrix_min_4 = knotting_min(t, z_4, F=F, param=q)
