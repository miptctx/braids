...
t, matrix_min_9 = knotting_min(t, 9, F=F, param=q)
t, matrix_min_4 = knotting_min(t, 4, F=F, param=q)
t, matrix_min_7 = knotting_min(t, 7, F=F, param=q)
t, matrix_min_8 = knotting_min(t, 8, F=F, param=q)
t, matrix_min_5 = knotting_min(t, 5, F=F, param=q)
t, matrix_min_6 = knotting_min(t, 6, F=F, param=q)
