# Рассматриваем косу с одним твистом которая соответствует тривиальному узлу
...
t_125,t_134,t_145,t_234,t_245 = var("t_125,t_134,t_145,t_234,t_245")

F = QQ

T = sort_triangulation({1,2,5},{1,4,5},{1,3,4},{2,3,4},{2,4,5})
...
res = solve(eqs, t_125,t_134,t_145,t_234,t_245)
