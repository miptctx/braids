...
from braids.ptolemey.matrices import braiding
...
t, edges_result, m = braiding(T, edges_init, {z_1,z_4},{z_1,z_3},{z_3,z_5},{z_2,z_5},{z_2,z_4})
...
show(make_subs_matrix_for_edges(edges_init, m))
# show(m)
