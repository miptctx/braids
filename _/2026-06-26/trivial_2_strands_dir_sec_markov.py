...
t, edges_result = braiding(T, edges_init, {z_2,z_4},{z_1,z_5},{z_3,z_4})
...
raise("Система уравнений составляет некорректно, ребра нужно сопоставлять как в файле trefoil_3_strands_conjugation")
