...
#l_1 = matrix([[1, 0, 0], [0, cos_f(1,4,3,5), sin_f(1,4,3,5)], [0, -sin_f(1,4,3,5), cos_f(1,4,3,5)]])
#l_2 = matrix([[cos_f(1,2,4,3), -sin_f(1,2,4,3), 0], [sin_f(1,2,4,3), cos_f(1,2,4,3), 0], [0, 0, 1]])
...
# permutated pentagon, no sign correction
#r_1 = matrix([[cos_f(1,2,4,5), -sin_f(1,2,4,5), 0], [sin_f(1,2,4,5), cos_f(1,2,4,5), 0], [0, 0, 1]])
...
r_1 = matrix([[cos_f(1,2,4,5), -sin_f(1,2,4,5), 0], [sin_f(1,2,4,5), cos_f(1,2,4,5), 0], [0, 0, 1]])
r_2 = matrix([[1, 0, 0], [0, -cos_f(2,4,3,5), sin_f(2,4,3,5)], [0, -sin_f(2,4,3,5), -cos_f(2,4,3,5)]])
r_3 = matrix([[cos_f(1,2,3,5), 0, sin_f(1,2,3,5)], [0, 1, 0], [-sin_f(1,2,3,5), 0, cos_f(1,2,3,5)]])
