...
for z_1, z_2, z_3, z_4, z_5 in perms:
  ...
  #lhs = m_r[0][0].simplify_full()._maxima_()
  #rhs = m_l[0][0].simplify_full()._maxima_()

  lhs = m_r[0][0]._maxima_().fullratsimp()
  rhs = m_l[0][0]._maxima_().fullratsimp()

  print((rhs/lhs).fullratsimp().sage())
  # print((rhs/lhs).sage())

  # result = maxima.eval(f"ratsimp( {lhs.name()} / {rhs.name()} );")
  # print(result)
  ...
  print(m_l[0][0] == m_r[0][0])
  print("")
  print(m_l[0][0].simplify_full().subs({a_2: 2, a_3: 3, a_4: 4, a_5: 5}))
  print("")
  print(m_r[0][0].simplify_full().subs({a_2: 2, a_3: 3, a_4: 4, a_5: 5}))
  quit()
