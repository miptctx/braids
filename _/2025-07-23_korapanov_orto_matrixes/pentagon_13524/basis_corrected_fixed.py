...
#[   1.2247       0.0  0.7071*I]
#[     -2.0       3.0 -3.4641*I]
#[ 2.1213*I -2.8284*I   -3.6742]
### m right ###
#[-0.7071*I       0.0    1.2247]
#[   3.6742 -2.8284*I  2.1213*I]
#[-3.4641*I      -3.0       2.0]
...
Q = matrix([
  [0,               0,              1],
  [ cos_f(1,5,2,4), sin_f(1,5,2,4), 0],
  [-sin_f(1,5,2,4), cos_f(1,5,2,4), 0]
])
...
# TODO: use 1352 (counter clockwise)
P = matrix([
  [ 0             , 1,               0],
  [ cos_f(1,3,5,2), 0, -sin_f(1,3,5,2)],
  [ sin_f(1,3,5,2), 0,  cos_f(1,3,5,2)]
])
...
S = matrix([
  [1,               0,               0],
  [0,  cos_f(3,5,2,4),  sin_f(3,5,2,4)],
  [0, -sin_f(3,5,2,4),  cos_f(3,5,2,4)]
])
