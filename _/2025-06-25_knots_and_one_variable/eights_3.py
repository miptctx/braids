...
matrix_non_braid = Matrix(matrix_braid.base_ring(), matrix_braid.nrows(), matrix_braid.ncols(), list(matrix_braid))
matrix_non_braid[1, 1] = 17
show(matrix_non_braid)
print("Matrices min * non_braid * max")
show(matrix_min * matrix_non_braid * matrix_max)
