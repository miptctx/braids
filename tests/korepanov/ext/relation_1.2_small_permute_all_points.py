...
for z_1, z_2, z_3, z_4, z_5, z_6, z_7 in Permutations([1,2,3,4,5,6,7]):
  ...
  t_z_1, m_ij = braiding_ext(T,
                          (rotate_tuple(z_1,z_4,z_5,z_6),(z_1,z_5)),
                          (rotate_tuple(z_1,z_2,z_5,z_4),(z_2,z_4)),
                          (rotate_tuple(z_1,z_4,z_6,z_7),(z_1,z_6)),
                          (rotate_tuple(z_1,z_5,z_6,z_4),(z_4,z_5)),
                          (rotate_tuple(z_2,z_7,z_4,z_6),(z_6,z_7)),
                          (rotate_tuple(z_1,z_6,z_4,z_7),(z_1,z_4)),
                          (rotate_tuple(z_2,z_3,z_7,z_4),(z_2,z_7)),
                          (rotate_tuple(z_2,z_4,z_7,z_6),(z_4,z_6)),
                          (rotate_tuple(z_1,z_7,z_4,z_3),(z_3,z_7)),
                          (rotate_tuple(z_2,z_3,z_4,z_7),(z_2,z_4)),
                          (rotate_tuple(z_1,z_6,z_7,z_4),(z_1,z_7)),
                          (rotate_tuple(z_1,z_5,z_6,z_4),(z_1,z_6)),
                          (rotate_tuple(z_1,z_4,z_7,z_3),(z_3,z_4)),
                          (rotate_tuple(z_1,z_4,z_6,z_7),(z_4,z_7)),
                          (rotate_tuple(z_1,z_2,z_5,z_4),(z_1,z_5)),
                          (rotate_tuple(z_1,z_4,z_5,z_6),(z_4,z_6)),
                          F=F)

  t_z_2, m_kl = braiding_ext(T,
