...
for z_1, z_2, z_3, z_4, z_5, z_6, z_7 in Permutations([1,2,3,4,5,6,7]):
  P = sort_triangulation({z_1,z_2,z_4}, {z_2,z_3,z_4},{z_3,z_4,z_6},{z_4,z_5,z_6})

  t_12, m_12 = braiding_ext(P, (rotate_tuple(z_1,z_2,z_3,z_4),(z_2,z_4)), (rotate_tuple(z_3,z_6,z_5,z_4),(z_4,z_6)), F=F)

  t_21, m_21 = braiding_ext(P, (rotate_tuple(z_3,z_6,z_5,z_4),(z_4,z_6)), (rotate_tuple(z_1,z_2,z_3,z_4),(z_2,z_4)), F=F)
